...
import { Animated, Modal, View, Text, TouchableOpacity, BackHandler, StyleSheet, Image, Dimensions, StatusBar, TextInput, FlatList} from "react-native"; 
...
const ModalViewComp = memo(() =>
    <Modal visible={modalView} transparent = {true} style = {{position:"absolute"}} animationType="slide">
    <View style = {{position:"absolute", backgroundColor: "rgba(0, 0, 0, 0)", height: "100%", width:"100%", justifyContent:"flex-end", alignItems:"center"}}>
